...
export default function StepsCard({step, title, text}) {
  return (
    <div className='flex flex-col justify-center items-center px-4 border border-cyan-500 rounded-md py-4 text-white'>
        <div className='w-[60px] h-[60px] rounded-full flex justify-center items-center bg-cyan-300/80'>
